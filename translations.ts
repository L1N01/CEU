...
export const translations: Record<Language, Translations> = {
  ...
  'es': {
    ...
    faqA1: 'Pueden postularse estudiantes universitarios regularmente matriculados en instituciones de educación superior de Curitiba y región metropolitana. Es necesario comprobar la necesidad de vivienda estudiantil y participar del proceso de selección.',
